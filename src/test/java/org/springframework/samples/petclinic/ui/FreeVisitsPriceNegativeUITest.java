...
public class FreeVisitsPriceNegativeUITest {
  ...
  public void testFreeVisitsPricePositiveUI() throws Exception {
    ...
    assertEquals("Pongo", driver.findElement(By.xpath("//table[@id='raceResultsTable']/tbody/tr[4]/td[2]")).getText());
    ...
    assertEquals(freeVisit, "THIS IS NOT A FREE VISIT");
  }
