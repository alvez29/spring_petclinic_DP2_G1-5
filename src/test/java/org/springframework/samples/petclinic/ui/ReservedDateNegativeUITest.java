...
public class ReservedDateNegativeUITest {
	@LocalServerPort
	private int port;
	...
	public void testReservedDateExceptionNegativeUI() throws Exception {
		...
		driver.findElement(By.id("name")).click();
		driver.findElement(By.id("name")).clear();
		driver.findElement(By.id("name")).sendKeys("Date Exception Negative");
		driver.findElement(By.id("date")).click();
		driver.findElement(By.xpath("//div[@id='ui-datepicker-div']/div/a[2]/span")).click();
		driver.findElement(By.xpath("//div[@id='ui-datepicker-div']/div/a[2]/span")).click();
		driver.findElement(By.xpath("//div[@id='ui-datepicker-div']/div/a[2]/span")).click();
		...
		driver.findElement(By.id("place")).sendKeys("Pabellón Principe Felipe");
		driver.findElement(By.xpath("//button[@type='submit']")).click();
		driver.findElement(By.xpath("//form[@id='beauty']/div/div[2]/div")).click();
		assertEquals("This date is reserved",
				driver.findElement(By.xpath("//form[@id='beauty']/div/div[2]/div/span[2]")).getText());
	}
