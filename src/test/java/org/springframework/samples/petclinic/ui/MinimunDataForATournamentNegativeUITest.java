...
// Test UI de la historia de usuario #4 negativo

@ExtendWith(SpringExtension.class)
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class MinimunDataForATournamentNegativeUITest {
	@LocalServerPort
  private int port;
  ...
  public void testHistoriaDeUsuario4() throws Exception {
    ...
    driver.findElement(By.id("canodrome")).sendKeys("Test");
    ...
    driver.findElement(By.xpath("//form[@id='race']/div[2]/div")).click();
    driver.findElement(By.xpath("//button[@type='submit']")).click();
    assertEquals("It must be a positive number", driver.findElement(By.xpath("//form[@id='race']/div/div[5]/div/span[2]")).getText());
    assertTrue(driver.findElement(By.xpath("//form[@id='race']/div/div[5]/div/span[2]")).isDisplayed());
  }
