...
public class PendingSponsorAmountPositiveUITest {
	@LocalServerPort
	private int port;
	...
	public void testPendingSponsorPositiveUI() throws Exception {
		...
		driver.findElement(By.id("name")).sendKeys("Positive UI Test");
		...
		assertEquals("PENDING",
				driver.findElement(By.xpath("//table[@id='tournamentsTable']/tbody/tr[2]/td[4]")).getText());
	}
